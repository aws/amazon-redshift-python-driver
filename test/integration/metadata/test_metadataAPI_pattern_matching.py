...
startup_stmts: typing.Tuple[str, ...] = (
    ...
    "create table {}.{} ({} INT, {} INT, {} INT, {} INT, {} INT, {} INT, {} INT, {} INT, {} INT, {} INT, {} INT, {} INT, {} INT);".format(
        name_list[0],
        name_list[0],
        name_list[0],
        name_list[1],
...
test_cases = [
    ...
    (
        "test_n𝒜m好e123 pattern",
        2,
        ["test%n𝒜m好e123 pattern", "test_n𝒜m好e123 pattern"],
        ["test_n𝒜m好e123 pattern", "test%n𝒜m好e123 pattern"],
    ),
    # 1.2 Exact match for underscore
    ("test\\_n𝒜m好e123 pattern", 1, ["test_n𝒜m好e123 pattern"], ["test_n𝒜m好e123 pattern"]),
    # 1.3 Pattern match for backslash following by single character
    (
        "test\\\\_n𝒜m好e123 pattern",
        2,
        ["test\\%n𝒜m好e123 pattern", "test\\_n𝒜m好e123 pattern"],
        ["test\\_n𝒜m好e123 pattern", "test\\%n𝒜m好e123 pattern"],
    ),
    # 1.4 Exact match for backslash following by underscore
    ("test\\\\\\_n𝒜m好e123 pattern", 1, ["test\\_n𝒜m好e123 pattern"], ["test\\_n𝒜m好e123 pattern"]),
    ...
    ("test\\%n𝒜m好e123 pattern", 1, ["test%n𝒜m好e123 pattern"], ["test%n𝒜m好e123 pattern"]),
    ...
    (
        "test\\__n𝒜m好e123 pattern",
        2,
        ["test_\\n𝒜m好e123 pattern", "test__n𝒜m好e123 pattern"],
        ["test_\\n𝒜m好e123 pattern", "test__n𝒜m好e123 pattern"],
    ),
    # 3.3 Pattern match for single character following by an underscore
    (
        "test_\\_n𝒜m好e123 pattern",
        2,
        ["test\\_n𝒜m好e123 pattern", "test__n𝒜m好e123 pattern"],
        ["test\\_n𝒜m好e123 pattern", "test__n𝒜m好e123 pattern"],
    ),
    # 3.4 Exact match for double underscore
    ("test\\_\\_n𝒜m好e123 pattern", 1, ["test__n𝒜m好e123 pattern"], ["test__n𝒜m好e123 pattern"]),
    # 3.5 Pattern match for backslash following by single character and underscore
    ("test\\\\_\\_n𝒜m好e123 pattern", 1, ["test\\\\_n𝒜m好e123 pattern"], ["test\\\\_n𝒜m好e123 pattern"]),
    # 3.6 Pattern match for underscore following by backslash and single character
    ("test\\_\\\\_n𝒜m好e123 pattern", 1, ["test_\\\\n𝒜m好e123 pattern"], ["test_\\\\n𝒜m好e123 pattern"]),
    # 3.7 Pattern match for backslash following by single character and backslash and single character
    ("test\\\\_\\\\_n𝒜m好e123 pattern", 1, ["test\\_\\_n𝒜m好e123 pattern"], ["test\\_\\_n𝒜m好e123 pattern"]),
    ...
    (
        "test\\%%n𝒜m好e123 pattern",
        4,
        ["test%%n𝒜m好e123 pattern", "test%\\\\n𝒜m好e123 pattern", "test%\\n𝒜m好e123 pattern", "test%n𝒜m好e123 pattern"],
        ["test%n𝒜m好e123 pattern", "test%\\n𝒜m好e123 pattern", "test%\\\\n𝒜m好e123 pattern", "test%%n𝒜m好e123 pattern"],
    ),
    ...
    (
        "test%\\%n𝒜m好e123 pattern",
        4,
        ["test%%n𝒜m好e123 pattern", "test%n𝒜m好e123 pattern", "test\\%n𝒜m好e123 pattern", "test\\\\%n𝒜m好e123 pattern"],
        ["test%n𝒜m好e123 pattern", "test\\%n𝒜m好e123 pattern", "test\\\\%n𝒜m好e123 pattern", "test%%n𝒜m好e123 pattern"],
    ),
    ...
    (
        "test\\\\%\\%n𝒜m好e123 pattern",
        2,
        ["test\\%n𝒜m好e123 pattern", "test\\\\%n𝒜m好e123 pattern"],
        ["test\\%n𝒜m好e123 pattern", "test\\\\%n𝒜m好e123 pattern"],
    ),
    ...
    (
        "test\\\\%\\\\%n𝒜m好e123 pattern",
        3,
        ["test\\\\%n𝒜m好e123 pattern", "test\\\\_n𝒜m好e123 pattern", "test\\_\\_n𝒜m好e123 pattern"],
        ["test\\\\_n𝒜m好e123 pattern", "test\\\\%n𝒜m好e123 pattern", "test\\_\\_n𝒜m好e123 pattern"],
    ),
]
