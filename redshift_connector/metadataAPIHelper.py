...
class MetadataAPIHelper:
    ...
    _get_schemas_col: typing.Dict = {"TABLE_SCHEM": int(RedshiftOID.VARCHAR), "TABLE_CATALOG": int(RedshiftOID.VARCHAR)}

    _TablesColNum: int = 10
    _get_tables_col: typing.Dict = {
        "TABLE_CAT": int(RedshiftOID.VARCHAR),
