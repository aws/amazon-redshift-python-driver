...
from metadata_test_utils import setup_metadata_test_env, teardown_metadata_test_env, get_connection_properties, ProcedureType, FunctionType, ENABLE_CASE_SENSITIVE_IDENTIFIER_SQL
...
tem_object_name_lower_case: str = "təst_nam好e$123\\n\\t\\r\\0`~!@#$%^&*()_+-={}[]:\";,./<>?\\'' delimited"
tem_object_identifier: str = "təst_nam好e$123\\\\n\\\\t\\\\r\\\\0`~!@#$%^&*()_+-={}[]:\";,./<>?\\\\'' delimited"
tem_object_identifier_mixed_case: str = "təst_Nam好e$123\\\\n\\\\t\\\\r\\\\0`~!@#$%^&*()_+-={}[]:\";,./<>?\\\\'' Delimited"

function_col_name: str = "testName123" # Hit error with unicode / $
...
startup_stmts: typing.Tuple[str, ...] = (
    ...
    "create table \"{}\".\"{}\" (child_id INT PRIMARY KEY, \"{}\" INT, FOREIGN KEY (\"{}\") REFERENCES \"{}\".\"{}\"(\"{}\"));".format(tem_object_sql_name,tem_object_sql_name+" child",tem_object_sql_name,tem_object_sql_name,tem_object_sql_name,tem_object_sql_name+" parent",tem_object_sql_name),
...
class TestDelimitedIdentifierCaseSensitive:
    @pytest.fixture(scope="class", autouse=True)
    def test_metadataAPI_config(self, request, db_kwargs):
        setup_metadata_test_env(db_kwargs, catalog_name, startup_stmts, True, True, catalogs_sql_name)

        def fin():
            teardown_metadata_test_env(db_kwargs, catalogs_sql_name, True, True)
    ...
    primary_key_test_cases = [
        # Delimited identifier with lower case
        ([catalog_identifier, tem_object_name_lower_case, tem_object_name_lower_case+" parent"], 0,
         []),
        ...
        # Delimited identifier with mixed case + non-printable UTF8 (control character)
        ([catalog_identifier, "təst_Nam好e$123\n\t\r\0`~!@#$%^&*()_+-={}[]:\";,./<>?\\\\'' Delimited", tem_object_name+" parent"], 0,
         []),
    ]
    ...
    imported_key_test_cases = [
        # Delimited identifier with lower case
        ([catalog_identifier, tem_object_name_lower_case, tem_object_name_lower_case+" child"], 0,
         []),
        ...
        # Delimited identifier with mixed case + non-printable UTF8 (control character)
        ([catalog_identifier, "təst_N𝒜m好e$123\n\t\r\0`~!@#$%^&*()_+-={}[]:\";,./<>?\\\\'' Delimited", tem_object_name+" child"], 0,
         []),
    ]
    ...
    best_row_identifier_test_cases = [
        # Delimited identifier with lower case
        ([catalog_identifier, tem_object_name_lower_case, tem_object_name_lower_case+" parent", 1, False], 0,
         []),
        ...
        # Delimited identifier with mixed case + non-printable UTF8 (control character)
        ([catalog_identifier, "təst_Nam好e$123\n\t\r\0`~!@#$%^&*()_+-={}[]:\";,./<>?\\\\'' Delimited", tem_object_name+" parent", 1, False], 0,
         []),
    ]
    ...
    column_privileges_test_cases = [
        # Delimited identifier with lower case
        ([catalog_identifier, tem_object_name_lower_case, tem_object_name_lower_case + " parent", tem_object_identifier], 0,
         []),

        # Delimited identifier with mixed case
        ([catalog_identifier, tem_object_name, tem_object_name + " parent", tem_object_identifier_mixed_case], 1,
         [
             [catalog_name, tem_object_name, tem_object_name + " parent", tem_object_name, "awsuser", user1_object_name, "SELECT", "NO"],
         ]),

        # Delimited identifier with mixed case + non-printable UTF8 (control character)
        ([catalog_identifier, "təst_Nam好e$123\n\t\r\0`~!@#$%^&*()_+-={}[]:\";,./<>?\\\\'' Delimited", tem_object_identifier_mixed_case + " parent", tem_object_identifier_mixed_case], 0,
         []),

        # Delimited identifier with lower case
        ([catalog_identifier, tem_object_name_lower_case, tem_object_name_lower_case + " child", tem_object_identifier], 0,
         []),

        # Delimited identifier with mixed case
        ([catalog_identifier, tem_object_name, tem_object_name + " child", tem_object_identifier_mixed_case], 0,
         []),

        # Delimited identifier with mixed case + non-printable UTF8 (control character)
        ([catalog_identifier, "təst_Nam好e$123\n\t\r\0`~!@#$%^&*()_+-={}[]:\";,./<>?\\\\'' Delimited", tem_object_identifier_mixed_case + " child", tem_object_identifier_mixed_case], 0,
         []),
    ]
    ...
    table_privileges_test_cases = [
        ...
        # Delimited identifier with mixed case + non-printable UTF8 (control character)
        ([catalog_identifier, "təst_Nam好e$123\n\t\r\0`~!@#$%^&*()_+-={}[]:\";,./<>?\\\\'' Delimited", tem_object_identifier_mixed_case+" parent"], 0,
         []),

        # Delimited identifier with lower case
        ([catalog_identifier, tem_object_identifier, tem_object_identifier+" child"], 0,
         []),

        # Delimited identifier with mixed case
        ([catalog_identifier, tem_object_identifier_mixed_case, tem_object_identifier_mixed_case+" child"], 1,
         [
            [catalog_name, tem_object_name, tem_object_name+" child", "awsuser", user2_object_name, "SELECT", "NO"]
         ]),

        # Delimited identifier with mixed case + non-printable UTF8 (control character)
        ([catalog_identifier, "təst_Nam好e$123\n\t\r\0`~!@#$%^&*()_+-={}[]:\";,./<>?\\\\'' Delimited", tem_object_identifier_mixed_case+" child"], 0,
         []),
    ]
    ...
    procedures_test_cases = [
        # Delimited identifier with lower case
        ([catalog_identifier, tem_object_identifier, tem_object_identifier], 0,
         []),

        # Delimited identifier with mixed case
        ([catalog_identifier, tem_object_identifier_mixed_case, tem_object_identifier_mixed_case], 1,
         [
            [catalog_name, tem_object_name, tem_object_name, None, None, None, '', ProcedureType.RETURNS_RESULT]
         ]),

        # Delimited identifier with mixed case + non-printable UTF8 (control character)
        ([catalog_identifier, "təst_Nam好e$123\n\t\r\0`~!@#$%^&*()_+-={}[]:\";,./<>?\\\\'' Delimited", tem_object_identifier_mixed_case], 0,
         []),
    ]
    ...
    procedure_columns_test_cases = [
        # Delimited identifier with lower case
        ([catalog_identifier, tem_object_identifier, tem_object_identifier, tem_object_identifier], 0,
         []),

        # Delimited identifier with mixed case
        ([catalog_identifier, tem_object_identifier_mixed_case, tem_object_identifier_mixed_case, tem_object_identifier_mixed_case], 1,
         [
    ...
    @pytest.mark.skip(reason="temporarily disable due to known QP issue")
    ...
    function_columns_test_cases = [
        ...
        # Delimited identifier with mixed case
        ([catalog_identifier, tem_object_identifier_mixed_case, tem_object_identifier_mixed_case, function_col_name], 1,
         [
