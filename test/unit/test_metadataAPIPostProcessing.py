...
SHOW_DATABASES_COL: typing.List[typing.Dict] = [
    show_databases_column(),
    show_databases_column_extra(),
    show_databases_column_diff_order(),
]
SHOW_DATABASES_RES: typing.List[typing.List] = [
    ["testCatalog", "1", "share", None, None, None],
    ["testCatalog", "1", "share", None, None, None, "extra_1", "extra_2", "1", "2"],
    [
        None,
        "testCatalog",
        "1",
...
SHOW_SCHEMAS_COL: typing.List[typing.Dict] = [
    show_schemas_column(),
    show_schemas_column_extra(),
    show_schemas_column_diff_order(),
]
SHOW_SCHEMAS_RES: typing.List[typing.List] = [
    ["testCatalog", "testSchema", "100", "share", None, None, None],
    ["testCatalog", "testSchema", "100", "share", None, None, None, "extra_1", "1", "2"],
    [None, "testCatalog", "testSchema", "100", "share", None, None],
]
...
SHOW_TABLES_COL: typing.List[typing.Dict] = [
    show_tables_column(),
    show_tables_column_extra(),
    show_tables_column_diff_order(),
]
SHOW_TABLES_RES: typing.List[typing.List] = [
    ["testCatalog", "testSchema", "testTable", "testTableType", "testAcl", "testRemarks"],
    [
        "testCatalog",
        "testSchema",
        "testTable",
    ...
    ["testRemarks", "testCatalog", "testSchema", "testTable", "testTableType", "testAcl"],
]
...
def test_get_tables_post_processing(show_tables_col, show_tables_res) -> None:
    ...
    # Apply post-processing
    final_rs: typing.Tuple = mock_metadataAPIPostProcessing.get_table_post_processing(
        intermediate_rs_list, ["testTableType"]
    )
...
SHOW_COLUMNS_COL: typing.List[typing.Dict] = [
    show_columns_column(),
    show_columns_column_extra(),
    show_columns_column_diff_order(),
]
