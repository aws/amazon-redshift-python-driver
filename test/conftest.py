...
@pytest.fixture(scope="class")
def redshift_browser_idc() -> typing.Dict[str, typing.Union[str, bool, int]]:
    db_connect = {
        ...
        "start_url": conf.get("redshift-browser-idc", "start_url", fallback=None),
        "idc_region": conf.get("redshift-browser-idc", "idc_region", fallback=None),
        "idc_response_timeout": conf.getint("redshift-browser-idc", "idc_response_timeout", fallback=120),
        "idc_client_display_name": conf.get("redshift-browser-idc", "idc_client_display_name",
                                            fallback="Amazon Redshift Python connector"),
        "identity_namespace": conf.get("redshift-browser-idc", "identity_namespace", fallback=None),
    }
    return db_connect

@pytest.fixture(scope="class")
def redshift_idp_token_auth_plugin() -> typing.Dict[str, typing.Union[str, bool, int]]:
    db_connect = {
