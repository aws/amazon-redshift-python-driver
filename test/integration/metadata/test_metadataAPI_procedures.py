...
get_procedure_columns_result: typing.List[ProcedureColumnInfo] = [
    ...
    ProcedureColumnInfo(current_catalog, test_schema_1, test_proc_1, "test_column_char", ProcedureColumnType.IN, 1, "char", 20, 20, 0, 10, 2, "", None, 1, None, None, 8, "", test_proc_1_specific_name),
    ProcedureColumnInfo(current_catalog, test_schema_1, test_proc_1, "test_column_varchar", ProcedureColumnType.IN, 12, "varchar", 256, 256, 0, 10, 2, "", None, 12, None, None, 9, "", test_proc_1_specific_name),
